          ...
          if (id) {
            try {
              ...
              if (userDocSnapshot.exists()) {
               ...
               if (!userData.userType === "super admin" && userData.userType === "visa officer") {
                router.push(`/dashboard/${id}/dashboard`);
              } else if (!userData.userType === "super admin" && userData.userType === "applicant") {
        ...
        */}
        ...
        <div class="mt-6">
            <div class="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Manage all user accounts and manage your personal profile with ease</p>
...
<div className='fixed bottom-0 left-0 z-10 w-full md:hidden lg:hidden bg-white border-t border-gray-400 p-4 flex justify-between'>
  ...
  {/*
  <button onClick={() => router.push(`/my-admin/${id}/evisa/manage`)}>
  <div className='flex items-center justify-center'>
