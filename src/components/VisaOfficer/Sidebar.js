          ...
          if (id) {
            try {
              ...
              if (userDocSnapshot.exists()) {
               ...
               if (!userData.userType === "visa officer" && userData.userType === "super admin") {
                router.push(`/my-admin/${id}/dashboard`);
              } else if (!userData.userType === "visa officer" && userData.userType === "applicant") {
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="flex-1 -mx-3 space-y-3 p-2">
            ...
            */}
            ...
            <div onClick={() => router.push(`/dashboard/${id}/dashboard`)} class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer">
...
{/*
        ...
        */}
            <div onClick={() => router.push(`/dashboard/${id}/evisa/manage`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                </svg>

                <span class="mx-2 text-sm font-medium">E-Visa Management</span>
            </div>
{/*
    ...
    */}
        ...
        <div class="mt-6">
            <div class="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                <h2 class="text-sm font-medium text-gray-800 dark:text-white">Welcome back Visa Admin!</h2>

                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Manage all e-visa applications and make precised decisions with ease</p>
...
<div className='fixed bottom-0 left-0 z-10 w-full md:hidden lg:hidden bg-white border-t border-gray-400 p-4 flex justify-between'>
  <button onClick={() => router.push(`/dashboard/${id}/dashboard`)}>
  ...
  <button onClick={() => router.push(`/dashboard/${id}/evisa/manage`)}>
  <div className='flex items-center justify-center'>
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
  </div> 
  <span className="btm-nav-label text-sm">E-Visa</span>
  </button>
{/*
