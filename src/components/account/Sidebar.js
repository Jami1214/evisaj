...
{/*
        ...
        */}
          ...
          {userDetails && userDetails.userType === "applicant" && (verificationStatus === "Verified"  && (  
            ...
            <div onClick={() => router.push(`/account/${id}/evisa/create`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 2.25L15 12" />
                </svg>

                <span class="mx-2 text-sm font-medium">Apply For E-visa</span>
            </div>

            <div onClick={() => router.push(`/account/${id}/evisa/manage`)} class="cursor-pointer flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" />
                </svg>

                <span class="mx-2 text-sm font-medium">Manage E-Visas</span>
            </div>
            </>
          ))}
        ...
        <div class="mt-6">
            <div class="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                <h2 class="text-sm font-medium text-gray-800 dark:text-white">Welcome Back Applicant!</h2>

                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Apply for Ghana E-Visa and manage all your applied E-Visa with ease</p>
...
<div className='fixed bottom-0 left-0 z-10 w-full md:hidden lg:hidden bg-white border-t border-gray-400 p-4 flex justify-between'>
  <button onClick={() => router.push(`/account/${id}/dashboard`)}>
    ...
    <span className="btm-nav-label text-sm">{verificationStatus === "Verified" ? 'Dashboard' : 'Verify Account'}</span>
  </button>
  {userDetails && userDetails.userType === "applicant" && (verificationStatus === "Verified"  ? (
    <>
 

  <button className="active" onClick={() => router.push(`/account/${id}/evisa/create`)}>
  <div className='flex items-center justify-center'>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 2.25L15 12" />
                </svg>
  </div>  
  <span className="btm-nav-label text-sm">Apply</span>
  </button>

  <button className="active" onClick={() => router.push(`/account/${id}/evisa/manage`)}>
  <div className='flex items-center justify-center'>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" />
