    ...
    useEffect(() => {
      const fetchProjects = async () => {
        try {
          ...
          userProjects.sort((a, b) => a.fullName.localeCompare(b.fullName));
  ...
  return (
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Browse through all your E-Visa applications</p>
        </div>
